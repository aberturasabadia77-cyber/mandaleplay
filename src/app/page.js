    ...
    <main style={{ background:'var(--bg)', minHeight:'100vh', overflowX:'hidden' }}>
      ...
      <nav style={{ position:'fixed', top:0, left:0, right:0, zIndex:50, padding:'18px 32px', display:'flex', alignItems:'center', justifyContent:'space-between', background:'rgba(6,6,12,0.85)', backdropFilter:'blur(24px)', borderBottom:'1px solid var(--border)' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:'20px' }}>
          ...
          <button onClick={() => window.location.href='/evento'} style={{ background:'var(--gold)', color:'#1a1200', border:'none', padding:'10px 22px', borderRadius:'100px', fontSize:'13px', fontWeight:'600', cursor:'pointer', fontFamily:"'DM Sans',sans-serif" }}>
            Crear mi evento
          </button>
        </div>
      </nav>
      ...
      <section style={{ minHeight:'100vh', display:'flex', alignItems:'center', position:'relative', overflow:'hidden', paddingTop:'80px' }}>
        ...
        <div style={{ maxWidth:'900px', margin:'0 auto', padding:'0 32px', position:'relative', zIndex:1 }}>
          ...
          <div style={{ display:'flex', gap:'12px', flexWrap:'wrap', marginBottom:'56px', animation:'fadeUp .8s ease' }}>
            <button onClick={() => window.location.href='/evento'} style={{ background:'var(--gold)', color:'#1a1200', border:'none', padding:'16px 36px', borderRadius:'100px', fontSize:'15px', fontWeight:'600', cursor:'pointer', fontFamily:"'DM Sans',sans-serif", display:'flex', alignItems:'center', gap:'8px', boxShadow:'0 8px 40px rgba(232,201,122,0.2)' }}>
      ...
      <section id="ocasiones" style={{ padding:'100px 32px' }}>
        <div style={{ maxWidth:'900px', margin:'0 auto' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(200px,1fr))', gap:'12px' }}>
            {OCASIONES.map((oc,i)=>(
              <button key={i} className="reveal" onClick={() => window.location.href='/evento'}
      ...
      <section style={{ padding:'100px 32px', position:'relative', overflow:'hidden' }}>
        ...
        <div className="reveal" style={{ maxWidth:'680px', margin:'0 auto', textAlign:'center', position:'relative', zIndex:1 }}>
          ...
          <button onClick={() => window.location.href='/evento'} style={{ background:'var(--gold)', color:'#1a1200', border:'none', padding:'18px 48px', borderRadius:'100px', fontSize:'16px', fontWeight:'600', cursor:'pointer', fontFamily:"'DM Sans',sans-serif", boxShadow:'0 8px 60px rgba(232,201,122,0.3)' }}>
        ...
        <div style={{ position:'fixed', inset:0, zIndex:200, background:'rgba(6,6,12,0.95)', backdropFilter:'blur(24px)', display:'flex', alignItems:'center', justifyContent:'center', animation:'fadeIn .3s ease' }}>
          <div style={{ background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:'24px', padding:'48px 40px', maxWidth:'480px', width:'90%', textAlign:'center' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'10px' }}>
              ...
              <button onClick={() => window.location.href='/evento'} style={{ background:'none', border:'1px solid var(--border)', color:'var(--muted)', padding:'12px', borderRadius:'100px', fontSize:'13px', cursor:'pointer', fontFamily:"'DM Sans',sans-serif" }}>
                Cerrar
              </button>
            </div>
          </div>
